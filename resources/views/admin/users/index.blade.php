                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">عدد البيوت التي يمتلكها </th>
                                    ...
                                    <tr>
                                        ...
                                        <!--begin::Name=-->
                                        <td>
                                            <a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">{{$user->name}}</a>
                                        </td>
                                        <!--end::Name=-->
                                        <!--begin::Email=-->
                                        <td>
                                        ...
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">{{$user->house_count}}</a>
                                        <td class="text-end">
